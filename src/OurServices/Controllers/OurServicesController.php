...
class OurServicesController implements IRenderItems
{
    public function __construct()
    {
        add_shortcode('our_services', [$this, 'renderContainerTagClasses']);
    }
    ...
    public function renderContainerTagClasses(array $aAtts = [])
    {
        ...
        <div class="col-12 col-sm-12 col-lg-<?php echo $aAtts['item_size'] ?> service-txt">
            ...
            <div class="hero-btns service-btn">
                <a data-scroll="" href="<?php echo $aRedux_vars['our_service_contact_btn_url'] ?>"><?php echo $aRedux_vars['our_service_contact_btn'] ?></a>
            </div>
        </div>
        <?php
